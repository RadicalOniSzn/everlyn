  ...
  return (
    <section className="h-screen flex flex-col justify-center items-center text-center px-6 bg-gradient-to-r from-black to-gray-950 ">
      ...
      <div className="flex flex-col sm:flex-row gap-4 sm:gap-5 mt-8 sm:mt-9">
        <button className="hover:brightness-80 cursor-pointer text-white bg-gradient-to-l from-blue-600 to-purple-600 rounded-3xl py-[0.7rem] px-[2rem] transition-all duration-300">
        ...
        <button className=" hover:bg-gray-900 cursor-pointer text-white border border-gray-700 rounded-3xl py-[0.7rem] px-[1.5rem] transition-all duration-300">
